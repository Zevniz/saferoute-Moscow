...
def render_prometheus() -> str:
    ...
    lines: list[str] = [
        ...
        "# HELP saferoute_route_requests_total Route API requests grouped by profile, mode, and outcome.",
        "# TYPE saferoute_route_requests_total counter",
        "# HELP saferoute_route_request_duration_ms Route API request duration in milliseconds.",
        "# TYPE saferoute_route_request_duration_ms histogram",
